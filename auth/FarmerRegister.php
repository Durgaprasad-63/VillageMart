...
<head>
    ...
    <title>Seller Registration Portal</title>
    ...
    body{
            ...
            background: url('https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Farmer_.1.jpg/2560px-Farmer_.1.jpg') no-repeat center center fixed;
			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card" style="background: rgba(255, 255, 255, 0.7);">
						<div class="card-header" style="background-color:#292b2c"><h4 style="font-style:bold;color:goldenrod">Seller Registration<h4></div>
