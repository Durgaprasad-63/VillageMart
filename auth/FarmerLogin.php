...
<head>
	...
	<style>
		...
		body{
            ...
            background: url('https://wallpapercave.com/wp/wp7525688.jpg') no-repeat center center fixed;
					...
					<div class="card " style="background: rgba(255, 255, 255, 0.3)"; >
						...
						<div class="card-body border border-dark">
							<form name="my-form" action="FarmerLogin.php" method="post">
								...
								<br>
								<div class="col-md-6 offset-md-4">
									<label id="forgotPassword"  class="text-left"><a id='link'  href="FarmerForgotPassword.php"><b style="color:black ;text-align:left"> Forgot your password </b></a></label>
									<br>
