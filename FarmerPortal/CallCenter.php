...
<body>
     ...
     <body>
          ...
          <div class="row" style="text-align:center;">
               ...
               <div class="col-md-3 col-sm-12">
                    <a href="CallCenter.php" id="navbar"><i class="fa fa-phone fa-rotate-vertical" aria-hidden="true"></i><label>Customer Care</label></a>
               </div>
          </div>
          <hr>
               ...
               <div class="card-body">
                    ...
                    <div class="card-deck">
                         <div class="card">
                              ...
                              <div class="card-body">
                                   <h5 class="card-title font-weight-bold text-center">help line</h5>
                                   <p class="card-text">phone no : 7981110729<br>
                                        email : sandilya@gmail.com <br>
                                        address : rushikonda,vizag,530045 <br>
                                        landline : 1800 103 4345
                                   </p>
